    ...
    setup = function()
        ...
        local function quick_run_file()
            ...
            local runners = {
                ...
                typescript = function() return {"ts-node", file} end,
                lua = function()
        ...
        local function quick_compile()
            ...
            local compilers = {
                c = function() return {"gcc", file, "-o", name} end,
                cpp = function() return {"g++", file, "-o", name} end,
                rust = function() return {"rustc", file} end,
                go = function() return {"go", "build", file} end,
                java = function() return {"javac", filename} end,
            }
        ...
        local function quick_test()
            ...
            local test_runners = {
                python = function()
                    ...
                    if vim.fn.filereadable(cwd .. "/pytest.ini") == 1 or
                ...
                go = function() return {"go", "test", "-v", file} end,
                rust = function() return {"cargo", "test"} end,
                r = function() return {"Rscript", "-e", string.format("testthat::test_file('%s')", file)} end,
            }
        ...
        local function quick_profile()
            ...
            local profilers = {
                python = function() return {"python3", "-m", "cProfile", file} end,
                r = function() return {"Rscript", "-e", string.format("profvis::profvis(source('%s'))", file)} end,
                javascript = function() return {"node", "--prof", file} end,
            }
        ...
        vim.keymap.set("n", "<leader>rq", quick_run_file, { desc = "Quick run file" })
        vim.keymap.set("n", "<leader>rc", quick_compile, { desc = "Quick compile" })
        vim.keymap.set("n", "<leader>rt", quick_test, { desc = "Quick test" })
        ...
        vim.keymap.set("n", "<leader>rl", function()
            ...
            local linters = {
                python = function() return {"flake8", file} end,
                javascript = function() return {"eslint", file} end,
                typescript = function() return {"eslint", file} end,
                r = function() return {"Rscript", "-e", string.format("lintr::lint('%s')", file)} end,
                sh = function() return {"shellcheck", file} end,
                lua = function() return {"luacheck", file} end,
            }
