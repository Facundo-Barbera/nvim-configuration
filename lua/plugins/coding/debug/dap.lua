return {
	{
		...
		config = function()
			...
			dap.adapters.node2 = {
				...
				args = {
					vim.fn.stdpath("data")
						.. "/mason/packages/node-debug2-adapter/node_modules/node-debug2/out/src/nodeDebug.js",
				},
			}
			...
			vim.api.nvim_create_user_command("DapClearBreakpoints", function()
				...
				-- All breakpoints cleared silently
			end, {})
			...
			vim.api.nvim_create_user_command("DapListBreakpoints", function()
				...
				if vim.tbl_isempty(breakpoints) then
					-- No breakpoints set (silent)
				else
					-- Breakpoints listed silently
				end
			end, {})
		end,
	},
